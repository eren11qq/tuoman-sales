...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "拓漫 TouMan 科技蓝主题",
        "colors": {
            "banner_border": "#1E40AF",
            "banner_title": "#60A5FA",
        ...
        "branding": {
            ...
            "welcome": "拓漫 TouMan — AI漫剧行业智能获客Agent，输入消息开始使用",
            "goodbye": "再见！",
            "response_label": " 拓漫 ",
            "prompt_symbol": "❯",
