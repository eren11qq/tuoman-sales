"""Slash command definitions and autocomplete for the 拓漫 TouMan CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of 拓漫 config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal 拓漫 works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while 拓漫 is working", "Configuration",
    ...
    CommandDef("update", "Update 拓漫 TouMan to the latest version", "Info"),
    CommandDef("version", "Show 拓漫 TouMan version", "Info", aliases=("v",)),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to 拓漫 TouMan or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
